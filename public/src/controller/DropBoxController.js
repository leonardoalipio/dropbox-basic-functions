class DropBoxController {
    ...
    initFirebase() {
        var config = {
            ...
            storageBucket: "dropbox-basic-function.appspot.com",
            messagingSenderId: "362096962724"
        };
    ...
    removeTask() {
        ...
        this.getSelection().forEach(li => {
            ...
            promises.push(this.ajax('/file', 'DELETE', 
                formData, ()=>{
        ...
        this.btnDelete.addEventListener('click', e => {
            this.removeTask().then(responses => {
                responses.forEach(resp => {
                    ...
                    if (resp.fields.key) {
                        this.getFirebaseRef().child(resp.fields.key)
                        .remove();
                    }
                })
            }).catch(err => {
    ...
    uploadTask(files) {
        ...
        [...files].forEach(file => {
            ...
            promises.push(this.ajax('/upload', 'POST', 
                formData, ()=>{
                    this.uploadProgress(event, file);
                }, ()=>{
                    this.startUploadTime = Date.now();
    ...
    formatTimeToHuman(duration){
        ...
        let minutes = parseInt((duration / (1000 * 600)) % 60);
